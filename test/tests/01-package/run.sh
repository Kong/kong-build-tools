...
# the tests are run inside docker images generated by `docker-kong`, so these
# files should have 'kong:root' ownership because of OpenShift: https://github.com/Kong/docker-kong/pull/243
files_docker=(
  "/usr/local/kong/"
  "/usr/local/bin/kong"
)
