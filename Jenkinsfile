            ...
            parallel {
                stage('Kong Enterprise DEB') {
                    ...
                    steps {
                        ...
                        sh 'make RESTY_IMAGE_BASE=ubuntu RESTY_IMAGE_TAG=20.04 DOCKER_MACHINE_ARM64_NAME="jenkins-kong-"`cat /proc/sys/kernel/random/uuid` package-kong test cleanup'
                    }
                }
            }
        }
