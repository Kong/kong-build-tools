            ...
            parallel {
                ...
                stage('Kong Enterprise src & Alpine'){
                    ...
                    steps {
                        ...
                        sh 'make CACHE=false RESTY_IMAGE_BASE=alpine RESTY_IMAGE_TAG=3 PACKAGE_TYPE=apk DOCKER_MACHINE_ARM64_NAME="jenkins-kong-"`cat /proc/sys/kernel/random/uuid` package-kong test cleanup'
                    }
                }
