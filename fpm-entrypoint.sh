...
elif [[ "$KONG_PACKAGE_NAME" == "kong-enterprise-edition" ]]; then
...
elif [[ "$KONG_PACKAGE_NAME" == "kong-enterprise-edition-fips" ]] || [[ "$SSL_PROVIDER" == 'boringssl' ]]; then
