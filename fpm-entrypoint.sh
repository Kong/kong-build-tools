...
case "$PACKAGE_TYPE/$DISTRO_NAME" in
  apk/*)
    PACKAGE_FILENAME=${PACKAGE_FILENAME}.${PLATFORM_ARCH}.apk.tar.gz
    ;;

  deb/*)
    PACKAGE_FILENAME=${PACKAGE_FILENAME}.${DISTRO_VERSION}.${PLATFORM_ARCH}.deb
    ;;
  ...
  rpm/centos)
    PACKAGE_FILENAME=${PACKAGE_FILENAME}.el${DISTRO_VERSION}.${PLATFORM_ARCH}.rpm
    ;;

  rpm/*)
    PACKAGE_FILENAME=${PACKAGE_FILENAME}.rhel${DISTRO_VERSION}.${PLATFORM_ARCH}.rpm
    ;;
esac
